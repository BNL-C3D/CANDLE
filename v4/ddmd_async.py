...
class AsyncPipelineManager:
    ...
    def generate_pipeline_stages1(self):
        self.pipeline.add_stages(self.generate_molecular_dynamics_stage1())
    ...
    def generate_pipelines(self) -> List[Pipeline]:
        ...
        for _ in range(self.cfg.num_nodes):
            ...
            for _ in range(3): # Assume motif loop iterations to be 3
                self.generate_pipeline_stages1()
    ...
    def generate_molecular_dynamics_stage1(self) -> Stage:
        stage = Stage()
